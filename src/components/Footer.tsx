const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-1/2 z-10 flex -translate-x-1/2 items-center justify-between p-4 text-xl text-[#1f1818]">
      <div className="flex items-center justify-center gap-4">
        {/* Gmail */}
        <a href="mailto:zizou.aziz101@gmail.com">
          <svg
            width="1.5rem"
            height="1.5rem"
            viewBox="0 0 32 32"
        ...
        {/* LinkedIn */}
        <a
          href="https://linkedin.com/in/spayco/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        {/* Github */}
        <a href="https://github.com/SpaYco" target="_blank" rel="noreferrer">
          <svg
            width="1.5rem"
            height="1.5rem"
            viewBox="0 0 16 16"
        ...
        {/* Facebook */}
        <a
          href="https://www.facebook.com/iSpaYco"
          target="_blank"
          rel="noreferrer"
        >
          <svg
